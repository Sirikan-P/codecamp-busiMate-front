...
function MockDriverAddAddress() {
  const token = localStorage.getItem("token");
  const driver = useDriverStored((state) => state.driver);
  const driverSelectLatLng = useDriverStored(
    (state) => state.driverSelectLatLng
  );
  ...
  return (
    <div>
      ...
      <div>
        ...
        {/* แผนที่ */}
        <MapContainer className="h-[50vh]" center={[13.75, 100.499]} zoom={10}>
          <TileLayer
...
export default MockDriverAddAddress;
