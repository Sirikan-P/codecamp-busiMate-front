      ...
      <div className="flex flex-col justify-center items-center pt-5 ">
        <div className="w-full ">
          ...
          <form
            ...
            className="bg-cyan-50  h-full rounded-t-[60px] flex flex-col gap-5 justify-center place-items-center pb-30"
          >
            {/* Sign in */}
            <div className="w-full flex justify-items-start pl-15 ">
              <div className="text-[24px]  text-cyan-600 pt-20 pb-5">
                Sign In
              </div>
            </div>
