...
const ProfilePageUser = () => {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen bg-cyan-600 p-5"
    >
      <div
        className="bg-white w-full max-w-md p-6 m-5 rounded-lg shadow-lg h-screen"
      >
        <div
        ...
        >
          ...
          My Profile
            ...
            <div className="">
          {/* Make booking button */}
          <button onClick={()=> navigate('/user/booking/create') } className="bg-cyan-700 w-50 text-lg text-slate-300 p-2 rounded-md mt-10 shadow-2xl" >
            MAKE BOOKING
          </button>
          </div>
        </div>
...
{/* edit profile btn */}
        <button className="bg-cyan-600 w-40 text-md text-slate-300 p-2 rounded-md " onClick={hdlEdit}
        >
          EDIT PROFILE
        </button>
